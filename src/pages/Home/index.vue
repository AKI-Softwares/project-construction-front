<template>
  <MainLayout titulo="Painel de Controle">
    ...
    <!-- Layout de Duas Colunas para Ações Rápidas e Atividades Recentes -->
    <div class="dashboard-content">
      ...
      <div class="content-panel quick-actions-panel">
        ...
        <div class="actions-grid">
          <button class="action-btn" @click="navigate('/inspections/new')">
      ...
      <!-- Coluna Direita: Últimas Inspeções / Atividades -->
      <div class="content-panel recent-activity-panel">
        ...
        <div v-else class="activity-list">
          <div v-for="activity in recentActivities" :key="activity.id" class="activity-item">
            ...
            <button class="btn-view-activity" @click="navigate(`/inspections/${activity.id}`)" title="Ver detalhes">
...
// Nome do usuário logado (pode ser recuperado do seu estado global/localStorage futuramente)
...
// Dados estáticos simulados para o painel (Substituir pelas requisições da sua API)
const stats = ref({
  activeBuildings: 3,
...
onMounted(async () => {
  // Aqui você poderá fazer um Promise.allSettled() buscando dados reais do seu backend
  // para preencher o `stats` e as `recentActivities`
})
</script>
