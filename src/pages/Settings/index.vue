...
// Dados mockados — preparados para conectar ao back quando o endpoint existir
const company = ref({
  name: 'AKI Softwares',
  slug: 'aki-softwares',
  email: 'contato@akisoftwares.com.br',
  phone: '(44) 99999-9999',
  status: 'ACTIVE',
  statusSince: '2026-01-15T00:00:00.000Z',
  plan: {
...
function saveChanges() {
  // TODO: conectar quando o back tiver endpoint de self-service
  // PATCH /platform/companies/:id
  originalCompany.value = { ...company.value }
  editing.value = false
  showMessage('Alterações salvas! (funcionalidade pendente de integração com o back)')
}
...
function upgradeNotAvailable() {
  showMessage('Upgrade de plano estará disponível em breve.')
}
