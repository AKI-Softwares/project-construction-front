...
.apartments-tab-hint a {
  color: #00897b;
  font-weight: 600;
  text-decoration: none;
}

.apartments-tab-hint a:hover {
...
.apt-row-clickable-wrapper {
  display: contents;
  cursor: pointer;
}

.apt-row-clickable-wrapper > span {
  cursor: pointer;
}

.apt-row-clickable-wrapper > span:hover {
  opacity: 0.8;
}
...
.checklist-overlay-state.error {
  color: #fff;
}

.checklist-overlay-state.error .btn-cancel {
  padding: 10px 28px;
}
