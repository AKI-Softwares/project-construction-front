  ...
  <MainLayout titulo="Empreendimentos">
    ...
    <div v-if="activeTab === 'apartments'">
      ...
      <div v-if="aptMode === 'batch'" class="form-card">
        ...
        <button class="btn-cancel" style="margin-bottom: 10px; width: max-content;" @click="aptMode = null">← Voltar</button>
        <div class="info-box">
...
async function assignInline(apt, userId) {
  ...
  try {
    ...
    // Atualiza o objeto na lista local para que a UI reflita a mudança
